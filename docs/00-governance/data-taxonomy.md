...
| Stape Parent routing, parity and rollback | `Active guarded` | Measurement engineering | Account, Canada hosting, endpoint, 2FA, durable key, monitoring and health-only Preview are verified; production routing, consent-state, parity and conversion deduplication remain pending. |
